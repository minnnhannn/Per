<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transaction.aspx.cs" Inherits="bctest.transaction" Debug="true" %>
							...
							<div class="col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-1 ">
								...
								<div class="form-wrapper">
									...
									<div class="form-item">
										...
										<asp:Button runat="server" ID="btn_Confirm" class="md-btn btn-custom" style="font-family:'Microsoft JhengHei'" Text="送出" OnClick="Confirm_Click"></asp:Button>&nbsp <label style="font-family:'Microsoft JhengHei';color:black">可用餘額</label>
